...
clear
import excel using Test_esg_2.xlsx, sheet("Return Index") cellrange(B1:GJJ23) firstrow clear
...
** Import the second part
clear
import excel using Test_esg_2.xlsx, sheet("Return Index") cellrange(GJK1:NTR23) firstrow clear
...
** Import the third part
clear
import excel using Test_esg_2.xlsx, sheet("Return Index") cellrange(NTS1:UKN22) firstrow clear
